    ...
    <body>
        ...
        <jsp:include page="/menu.jsp"/>
            ...
            <div class="row">
                <div class="col-4"></div>
                <div class="col-8">
                    <h1 class="texto">Listado de Programas</h1>
                        ...
                        <tbody id="textoblanco">
                            <c:forEach items="${lista}" var="p">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn" value="primary" style="background-color: #708090" data-toggle="modal" data-target="#exampleModalCenter" onclick="editar('${p.idprograma}', '${p.nombreprograma}', '${p.descripcion}', '${p.idgenero}', '${p.idradio}')">Actualizar</button>
                                        <button type="button" class="btn btn-danger"  onclick="alerta_eliminar(${p.idprograma})"><a>Eliminar</a></button>
                                    </td>
                                </tr>
                            </c:forEach>                                
                        </tbody>
                    ...
                    <br><br>
                    <!-- Trigger -->
                    <button type="button" class="btn" value="primary" style="background-color: #FFFFFF" data-toggle="modal" data-target="#exampleModal">Agregar  Programa</button>
