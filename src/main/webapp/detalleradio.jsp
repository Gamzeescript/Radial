    ...
    <body>
        ...
        <jsp:include page="/menu.jsp"/>
            ...
            <div class="row">
                <div class="col-4"></div>
                <div class="col-8">
                    <h1 class="texto">Listado de Radios</h1>
                        ...
                        <tbody id="textoblanco">
                            <c:forEach items="${lista}" var="r">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn" value="primary" style="background-color: #708090" data-toggle="modal" data-target="#exampleModalCenter" onclick="editar('${r.idradio}', '${r.nombreradio}', '${r.descripcion}', '${r.idfrecuencia}', '${r.idconsorcio}')">Actualizar</button>
                                        <button type="button" class="btn btn-danger"  onclick="alerta_eliminar(${r.idradio})"><a>Eliminar</a></button>
                                    </td>
                                </tr>
                            </c:forEach>                                
                        </tbody>
