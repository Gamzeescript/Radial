    ...
    <body>
        ...
        <jsp:include page="/menu.jsp"/>
            ...
            <div class="row">
                <div class="col-4"></div>
                <div class="col-8">
                    <h1 class="texto">Listado de Generos</h1>
                        ...
                        <tbody id="textoblanco">
                            <c:forEach items="${lista}" var="g">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn" value="primary" style="background-color: #708090" data-toggle="modal" data-target="#exampleModalCenter" onclick="editar('${g.idgenero}', '${g.nombregenero}')">Actualizar</button>
                                        <button type="button" class="btn btn-danger"  onclick="alerta_eliminar(${g.idgenero})"><a>Eliminar</a></button>
                                    </td>
                                </tr>
                            </c:forEach>                                
                        </tbody>
                    ...
                    <br><br>
                    <!-- Trigger -->
                    <button type="button" class="btn" value="primary" style="background-color: #FFFFFF" data-toggle="modal" data-target="#exampleModal">Agregar  Genero</button>
                    ...
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalCenterTitle">Actualizar Genero</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form  method="POST" action="genero?action=actualizar">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Id Genero:</label>
                                            <input type="text" class="form-control" name="idgenero" id="idgenero" readonly="readonly" type="number" max="2">
                                        </div>
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Nombre:</label>
                                            <input type="text" class="form-control" name="nombregenero" id="nombregenero" type="number" max="2">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline-dark" data-dismiss="modal">cerrar</button>
                                            <button class="btn btn-outline-info" onclick="reload(true)">Guardar</button>
                    ...
                    <script type="text/javascript">
                        function editar(idgenero, nombregenero) {

                            /* Tomando los valores desde el javascript */
                            document.getElementById("idgenero").value = idgenero;
                            document.getElementById("nombregenero").value = nombregenero;

                        }
                    </script>
                    <script>
                          function alerta_eliminar(idgenero) {
                    Swal.fire({
                    ...
                    if (result.value) {
                        window.location.href = "genero?action=eliminar&idgenero=" + idgenero;
                    }
                })
            }
