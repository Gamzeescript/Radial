    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-4"></div>
                <div class="col-8">
                    <h1>Transmisiones disponibles</h1>
                        ...
                        <tbody>
                            <c:forEach items="${lista}" var="t">
                                <tr>
                                    ...
                                    <td>${t.descripcion}</td>
                                    <td>
                                        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModalCenter" onclick="editar('${t.idtransmision}', '${t.nombretransmision}', '${t.descripcion}')">Actualizar</button>
                                        <button type="button" class="btn btn-outline-danger"  onclick="alerta_eliminar(${t.idtransmision})"><a>Eliminar</a></button>
                                    </td>
                                </tr>
                            </c:forEach>                                
                        </tbody>
                    ...
                    <br><br>
                    <!-- Trigger -->
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#exampleModal">Listar Transmision</button>
