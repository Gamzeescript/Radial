        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-8">
                        ...
                        <tbody>
                            <c:forEach items="${lista}" var="g">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModalCenter" onclick="editar('${g.idgenero}', '${g.nombregenero}')">Actualizar</button>
                                        <button type="button" class="btn btn-outline-danger"  onclick="alerta_eliminar(${g.idgenero})"><a>Eliminar</a></button>
                                    </td>
                                </tr>
                            </c:forEach>                                
                        </tbody>
                    ...
                    <br><br>
                    <!-- Trigger -->
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#exampleModal">Agregar  Genero</button>
