        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-8">
                        ...
                        <tbody>
                            <c:forEach items="${lista}" var="p">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModalCenter" onclick="editar('${p.idproduccion}', '${p.nombreproduccion}', '${p.idproductora}')">Actualizar</button>
                                        <button type="button" class="btn btn-outline-danger"  onclick="alerta_eliminar(${p.idproduccion})"><a>Eliminar</a></button>
                                    </td>
                                </tr>
                            </c:forEach>                                
                        </tbody>
                    ...
                    <br><br>
                    <!-- Trigger -->
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#exampleModal">Agregar  Produccion</button>
