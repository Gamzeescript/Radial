        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-8">
                        ...
                        <tbody>
                            <c:forEach items="${lista}" var="pr">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModalCenter" onclick="editar('${pr.idproductora}', '${pr.nombreproductora}', '${pr.rfc}', '${pr.telefono}', '${pr.idconsorcio}')">Actualizar</button>
                                        <button type="button" class="btn btn-outline-danger"  onclick="alerta_eliminar(${pr.idproductora})"><a>Eliminar</a></button>
                                    </td>
                                </tr>
                            </c:forEach>                                
                        </tbody>
                    ...
                    <br><br>
                    <!-- Trigger -->
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#exampleModal">Agregar  Productora</button>
